...
################################################################################
## Form generated from reading UI file 'otp_verification_modalaEfGDJ.ui'
##
...
class Ui_OtpVerificationDialog(object):
    def setupUi(self, OtpVerificationDialog):
        if not OtpVerificationDialog.objectName():
            OtpVerificationDialog.setObjectName(u"OtpVerificationDialog")
        OtpVerificationDialog.resize(527, 558)
        OtpVerificationDialog.setStyleSheet(u"QDialog {\n"
...
"    font-family: Arial;\n"
"}")
        self.verticalLayout = QVBoxLayout(OtpVerificationDialog)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.headerWidget = QWidget(OtpVerificationDialog)
        ...
        self.contentWidget = QWidget(OtpVerificationDialog)
...
"color: #1E293B;")
        ...
        self.phoneLineEdit.setMinimumSize(QSize(0, 0))
        self.phoneLineEdit.setMaximumSize(QSize(16777215, 16777215))
        ...
        self.digit1.setMinimumSize(QSize(62, 62))
        self.digit1.setMaximumSize(QSize(62, 62))
...
"padding: 0px;")
        ...
        self.digit2.setMinimumSize(QSize(62, 62))
        self.digit2.setMaximumSize(QSize(62, 62))
...
"padding: 0px;")
        ...
        self.digit3.setMinimumSize(QSize(62, 62))
        self.digit3.setMaximumSize(QSize(62, 62))
...
"padding: 0px;")
        ...
        self.digit4.setMinimumSize(QSize(62, 62))
        self.digit4.setMaximumSize(QSize(62, 62))
...
"padding: 0px;")
        ...
        self.digit5.setMinimumSize(QSize(62, 62))
        self.digit5.setMaximumSize(QSize(62, 62))
...
"padding: 0px;")
        ...
        self.digit6.setMinimumSize(QSize(62, 62))
        self.digit6.setMaximumSize(QSize(62, 62))
...
"padding: 0px;")
        ...
        self.timerFrame.setStyleSheet(u"background-color: #EBF8FF;\n"
"border: 1px solid #BEE3F8;\n"
"border-radius: 4px;")
...
"border: none;")
        ...
        self.footerFrame = QFrame(OtpVerificationDialog)
...
"}")
        ...
        self.verifyButton.setMaximumSize(QSize(120, 16777215))
...
"}")
        ...
        self.retranslateUi(OtpVerificationDialog)

        QMetaObject.connectSlotsByName(OtpVerificationDialog)
    # setupUi

    def retranslateUi(self, OtpVerificationDialog):
        OtpVerificationDialog.setWindowTitle(QCoreApplication.translate("OtpVerificationDialog", u"X\u00e1c th\u1ef1c Telethon", None))
        self.titleLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"X\u00e1c th\u1ef1c Telethon", None))
        self.titleLabel.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"titleLabel", None))
        self.iconLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"\u2709", None))
        self.messageLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"M\u00e3 OTP \u0111\u00e3 \u0111\u01b0\u1ee3c g\u1eedi \u0111\u1ebfn \u1ee9ng d\u1ee5ng Telegram c\u1ee7a b\u1ea1n", None))
        self.messageLabel.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"messageLabel", None))
        self.phoneLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"S\u1ed1 \u0111i\u1ec7n tho\u1ea1i:", None))
        self.phoneLabel.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"infoLabel", None))
        self.phoneLineEdit.setText(QCoreApplication.translate("OtpVerificationDialog", u"+84123456789", None))
        self.otpLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"Nh\u1eadp m\u00e3 x\u00e1c th\u1ef1c (6 ch\u1eef s\u1ed1):", None))
        self.otpLabel.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"infoLabel", None))
        self.digit1.setInputMask("")
        self.digit1.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"otpDigit", None))
        self.digit2.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"otpDigit", None))
        self.digit3.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"otpDigit", None))
        self.digit4.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"otpDigit", None))
        self.digit5.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"otpDigit", None))
        self.digit6.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"otpDigit", None))
        self.timerFrame.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"statusInfo", None))
        self.timerIconLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"\u23f1", None))
        self.timerLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"M\u00e3 c\u00f3 hi\u1ec7u l\u1ef1c trong:", None))
        self.timerLabel.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"timerLabel", None))
        self.timeLeftLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"04:31", None))
        self.timeLeftLabel.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"timerLabel", None))
        self.noteLabel.setText(QCoreApplication.translate("OtpVerificationDialog", u"M\u00e3 x\u00e1c th\u1ef1c c\u00f3 hi\u1ec7u l\u1ef1c trong 5 ph\u00fat. N\u1ebfu ch\u01b0a nh\u1eadn \u0111\u01b0\u1ee3c m\u00e3, vui l\u00f2ng ki\u1ec3m tra Telegram ho\u1eb7c l\u1ea5y m\u00e3 kh\u00e1c.", None))
        self.cancelButton.setText(QCoreApplication.translate("OtpVerificationDialog", u"H\u1ee7y", None))
        self.cancelButton.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"secondaryButton", None))
        self.verifyButton.setText(QCoreApplication.translate("OtpVerificationDialog", u"X\u00e1c th\u1ef1c", None))
        self.verifyButton.setProperty(u"class", QCoreApplication.translate("OtpVerificationDialog", u"primaryButton", None))
    # retranslateUi
